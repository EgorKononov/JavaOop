...
public class Main {
    public static void main(String[] args) {
        ...
        list1.addListItem(1, 1);
        list1.addListItem(2, 2);
        list1.addListItem(3, 3);
        System.out.println(list1);
        System.out.println();
        ...
        System.out.println(list1.getListItemData(2));
        System.out.println();

        System.out.println("Изменение элемента по индексу");
        System.out.println(list1.setListItemData(1, 5));
        System.out.println(list1);
        System.out.println();

        System.out.println("Удаление элемента по индексу");
        System.out.println(list1.removeListItem(2));
        System.out.println(list1);
        System.out.println();

        System.out.println("Удаление элемента по значению");
        System.out.println(list1.removeListItemByValue(3));
        System.out.println(list1);
        System.out.println();

        System.out.println("Удаление первого элемента");
        System.out.println(list1.removeHead());
        System.out.println(list1);
        System.out.println();

        System.out.println("Разворот списка");
        SinglyLinkedList<Integer> list2 = new SinglyLinkedList<>();
        list2.addListItem(0, 0);
        list2.addListItem(1, 1);
        list2.addListItem(2, 2);
        list2.addListItem(3, 3);
